...
class Starter(customtkinter.CTk):
    def __init__(self):
        ...
        self.login = CTkButton(master=self.main_frame, text="Log In", fg_color="#774280", hover_color="#9553a0", font=("Arial Bold", 14), text_color="#ffffff", width=200, height=35, corner_radius=12,command=self.get_entries)
